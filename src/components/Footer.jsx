          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300 cursor-help">
                ...
                <span
                  role="tooltip"
                  className="pointer-events-none absolute bottom-full left-0 mb-3 w-56 max-w-[calc(100vw-2rem)] rounded-lg bg-gray-800/95 backdrop-blur px-3 py-2 text-xs text-gray-200 shadow-xl ring-1 ring-white/10 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 z-20"
                >
                  Read how we collect, use, and protect your personal data on
                  JobPortal.
                  <span className="absolute top-full left-6 -translate-x-1/2 border-4 border-transparent border-t-gray-800/95"></span>
                </span>
              </a>
